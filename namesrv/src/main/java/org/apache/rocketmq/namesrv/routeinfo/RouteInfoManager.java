...
public class RouteInfoManager {
     ...
     * @param brokerName  名称
     * @param brokerId    id
     * @param haServerAddr ha代理服务器地址
     * @param topicConfigWrapper topic的配置
    ...
    public RegisterBrokerResult registerBroker(
        ...
        try {
            try {
                ...
                // 同一个brokerName，brokerId为0的为master节点，承担haServer的作用
